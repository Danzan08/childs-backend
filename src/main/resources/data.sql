...
INSERT INTO childs (child_id, active, actual_address, birth_date, first_name, patronymic, sex, registration_address, sur_name, user_id, organization_id) VALUES
    (1,true, 'г. Персик ул. Персика 1', '2019-10-10', 'ПЕРСИК', 'ПЕРСИКОВИЧ', true, 'г. Персик ул. Персиковая 1', 'ПЕРСИКОВ', 1,1),
    (2,true, 'г. Абрикос ул. Абрикосова 1', '2019-11-11', 'АБРИКОС', 'АБРИКОСОВИЧ', true, 'г. Абрикос ул. Абрикосовая 1', 'АБРИКОСОВ', 1,1),
    (3,false, 'г. Мандарин ул. Мандариновая 1', '2019-12-12', 'МАНДАРИН', 'МАНДАРИНОВИЧ', true, 'г. Мандарин ул. Мандариновая 1', 'МАНДАРИНОВ', 2,3),
    (4,true, 'г. Помидор ул. Помидоровая 1', '2017-01-12', 'ПОМИДОР', 'ПОМИДОРОВИЧ', true, 'г. Помидор ул. Помидоровая 1', 'ПОМИДОРОВ', 2,2),
    (5,true, 'г. Апельсин ул. Апельсиновая 1', '2018-01-12', 'АПЕЛЬСИН', 'АПЕЛЬСИНОВИЧ', true, 'г. Апельсин ул. Апельсиновая 1', 'АПЕЛЬСИНОВ', 3,2);
